...
class Game:
    def __init__(self):
        ...
        self.pos_numbers_text = self.utilities.get_list(coord_list_base)
        ...
        TextCard.get_card_numbers(Rectangle.size_rect_x // 2 + Rectangle.gap, Rectangle.size_rect_y // 2 + Rectangle.gap, self.pos_numbers_text,
                                  self.list_of_card_numbers, self.text_group)
        TextCard.get_card_numbers(Rectangle.size_rect_x // 2 + Rectangle.gap + 920, Rectangle.size_rect_y // 2 + Rectangle.gap, self.pos_numbers_text_enemy,
    ...
    def run_layer_screen_game(self):
        ...
        while running:
            ...
            self.card.draw_card_field(self.pos_numbers_card_field, self.layer_game)
            self.text_group.draw(self.layer_game)
            self.card2.draw_background_card(self.layer_game, Coords(920, 0))
            self.card2.draw_card_field(self.pos_numbers_card_field, self.layer_game)
